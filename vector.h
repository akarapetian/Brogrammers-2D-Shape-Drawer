...
class vector
{
    ...
    //vector& operator=vector(const vector& v); //copy assignment
    ...
    Type& operator[](int n); //return reference

    //const Type& operator[](int n); //return reference
...
//return reference, not sure how to implement ***
template <typename Type>
...
//return const reference, not sure how to implement ***
